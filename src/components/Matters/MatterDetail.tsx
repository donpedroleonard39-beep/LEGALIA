...
import { 
  ...
  deleteMatterDocument, deleteMatter, generateInviteLink 
    ...
    <div className="page-stack">
      ...
      <header className="flex flex-col gap-4 border-b border-[var(--border-subtle)] pb-6">
        ...
        <nav className="mt-4 flex gap-1 border-b border-[var(--border-subtle)]">
          <TabButton active={activeTab === 'overview'} onClick={() => setActiveTab('overview')} icon={<Info />} label="Brief" />
          <TabButton active={activeTab === 'timeline'} onClick={() => setActiveTab('timeline')} icon={<History />} label="Timeline" />
          <TabButton active={activeTab === 'vault'} onClick={() => setActiveTab('vault')} icon={<FileText />} label="Vault" />
          <TabButton active={activeTab === 'people'} onClick={() => setActiveTab('people')} icon={<Users />} label="People" />
          <TabButton active={activeTab === 'alerts'} onClick={() => setActiveTab('alerts')} icon={<BellIcon />} label="Alerts" />
        </nav>
      </header>
...
function BellIcon() { return <Clock className="h-4 w-4" />; }
...
// --- Placeholder Panels (To be fully implemented in services) ---
